...
<section id="awards" class="section-card">
  ...
  <ul style="line-height: 1.8; font-size: 15px;">
    ...
    <li><strong>Mechanical Engineering Alumni Scholarship</strong>, DUT (Top 0.5%, 2022)</li>
    <li><strong>Finalist Award</strong>, Mathematical Contest in Modeling (MCM/ICM, Top 1.8%–2.0%, 2022)</li>
    <li><strong>First Prize</strong>, Liaoning Provincial Mechanical Innovation Design Competition (2022)</li>
  </ul>
</section>

<!-- 7. Beyond Academia 板块 -->
<section id="beyond-academia" class="section-card">
  <h2>Beyond Academia</h2>
  <p style="margin-bottom: 25px; color: #666; font-size: 15px;">
    Life outside the lab keeps me inspired, grounded, and energized. Here are a few things I am passionate about:
  </p>
  ...
  <div class="hobby-grid">
    ...
    <div class="hobby-card">
      ...
      <div class="hobby-content">
        ...
        <p>
          Shooting with my Canon R50 and editing videos allows me to capture authentic moments, document vibrant landscapes, and tell visual stories from distinct perspectives.
        </p>
      </div>
    </div>
